...
console.warn(
  `Afiseaza ultimele doua cifre al anului de
  nastere al persoanei, folosind anul curent
  si metoda getAge(). (Exemplu: ‘87).`,
);
...
console.log(`Ma numesc ${person.getName()}
si am ${person.getAge()} ani.`);

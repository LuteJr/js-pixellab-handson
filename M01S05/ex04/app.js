...
console.warn(`Calculeaza suprafata de tapet necesara
...
apoi latimea si lungimea altui dreptunghi.
Functia se va numi aggregateSurfaceArea().`);

const aggregateSurfaceArea = (a, b, c, d) => {
  const first = calculateRectangleArea(a, b);
  const second = calculateRectangleArea(c, d);
